...
Route::post('/customer-reset-password', [CustomerController::class, 'customerResetPassword'])->middleware(['role:customer', TokenVerificationMiddleware::class]);
...
Route::post('/driver-reset-password', [DriverController::class, 'driverResetPassword'])->middleware(['role:driver', TokenVerificationMiddleware::class]);
